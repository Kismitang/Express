...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from 'vue-element-plus/src/utils/date-util';
  import ElScrollbar from 'vue-element-plus/packages/scrollbar';
  import RepeatClick from 'vue-element-plus/src/directives/repeat-click';
